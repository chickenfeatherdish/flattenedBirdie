...
var raf = function (x) {
  alert('Your browser is not compatible with this site. Sorry :(');
}
...
var gameLoaded = function () {
  ...
  game.div.appendChild(rank.img);
  game.div.appendChild(about.img);
...
var flap = loadGameSound('./re/flap.wav', 5);
var pipeslide = loadGameSound('./re/slide.wav', 3);
var clang = loadGameSound('./re/clang.wav', 3);

var coin1 = loadGameSound('./re/coin.wav', 3);
var coin2 = loadGameSound('./re/coin2.wav', 3);
var coin3 = loadGameSound('./re/coin3.wav', 3);
var coin4 = loadGameSound('./re/coin4.wav', 3);

var kick = loadGameSound('./re/kick.wav', 5);
var kick2 = loadGameSound('./re/kick2.wav', 5);
var kick3 = loadGameSound('./re/kick3.wav', 5);
var kick4 = loadGameSound('./re/kick4.wav', 5);
var kick5 = loadGameSound('./re/kick5.wav', 5);

var kicks = [kick, kick2, kick3, kick4, kick5];

var squish1 = loadGameSound('./re/squish1.wav', 3);
var squish2 = loadGameSound('./re/squish2.wav', 3);
...
gameover.reposition = function () {
  ...
  gameover.img.style.top = Math.floor(Math.cos(gameover.fr / 32) * 4 + (hh - 800) / 2) + 'px';
}
...
rank.showing = false;
rank.hiding = true;
rank.img = loadGameImage('./img/rank.png'); // 626 x 144
rank.img.style.position = 'absolute';
rank.img.style.opacity = 0;
rank.img.style.zIndex = '42069';
rank.reposition = function () {
  rank.img.style.left = Math.floor((ww - 626) / 2) + 'px';
  rank.img.style.top = Math.floor(Math.cos(gameover.fr / 32) * 4 + (hh - 500) / 2) + 'px';
}
rank.img.onclick = function () {
  paihangbang();
}
...
about.showing = false;
about.hiding = true;
about.img = loadGameImage('./img/about.png'); // 626 x 144
about.img.style.position = 'absolute';
about.img.style.opacity = 0;
about.img.style.zIndex = '42069';
about.reposition = function () {
  about.img.style.left = Math.floor((ww - 79) / 2) + 'px';
  about.img.style.top = Math.floor(Math.cos(gameover.fr / 32) * 4 + (hh - 100) / 2) + 'px';
}
about.img.onclick = function () {
  if (gameover.visible) {
    ...
    while (ltm < ftm) {
      ...
      */
      ...
      if (rank.a > .01) {
        if (!rank.visible) {
          rank.visible = true;
          rank.img.style.display = 'inline';
        }
      } else {
        if (rank.visible) {
          rank.visible = false;
          rank.img.style.display = 'none';
        }
      }
      ...
      if (about.showing) {
        ...
        about.img.style.opacity = about.a;
      ...
      if (about.a > .01) {
        if (!about.visible) {
          about.visible = true;
          about.img.style.display = 'inline';
        }
      } else {
        if (about.visible) {
          about.visible = false;
